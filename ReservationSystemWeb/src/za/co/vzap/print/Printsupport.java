		...
		public int print(Graphics graphics, PageFormat pageFormat, 
			...
			if (pageIndex == 0) {                    
				...
				try {
					...
					int imagewidth=100;
					int imageheight=50;
					BufferedImage read = ImageIO.read(getClass().getResource("resources/VZAP.jpg"));
				...
				try{
					/*Draw Header*/
					int y=80;
					g2d.drawString("Conference Room Reservation System", 40,y);  
					g2d.drawString("CopyWrite 2018", 50,y+10);                 //shift a line by adding 10 to y value
					g2d.drawString(now(), 10, y+20);                                //print date
					g2d.drawString("Employee : Excetutive", 10, y+30);  
